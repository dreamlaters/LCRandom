...
public class RandomQ {
    ...
    public static void main(String[] args) {
        List<Integer> all = new ArrayList<>(Set.of(1143, 97, 72, 115, 5, 312, 516, 300, 53, 152, 547, 305, 128, 78, 90, 46, 47, 77, 127, 490, 1,
                16, 18, 3, 76, 992, 307, 315, 382, 384, 208, 270, 450, 98, 96, 95, 144, 94, 145, 107, 297, 428, 166,
                ...
                48, 207, 33, 200, 89, 91, 402, 31, 148, 974, 21, 743, 215, 151, 468, 93, 752, 39, 8, 103, 69, 210, 41, 337, 79, 109, 139,
                347, 143, 283, 10051, 198, 322, 518, 543));
        Set<Integer> errorList = Set.of(1425, 743, 57);
        Set<Integer> done = Set.of(20, 5, 155, 209, 78, 450, 127, 128, 96, 235, 992, 144, 739, 145, 384, 18, 300, 503, 106, 270, 76,
                ...
                297, 166, 210, 143, 283, 1, 203, 151, 16, 337, 109, 322, 4, 198, 1143, 543, 8, 347, 31, 518);
