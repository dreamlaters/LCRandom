...
public class RandomQ {
    ...
    public static void main(String[] args) {
        List<Integer> all = List.of(1143, 97, 72, 115, 5, 312, 516, 300, 53, 152, 547, 305, 128, 78, 90, 46, 47, 77, 127, 490, 1,
                ...
                48, 207, 33, 200, 93, 89, 91, 402, 31, 148, 974, 166, 41, 21, 743, 215, 151, 468, 93, 752, 39, 8, 103, 89, 69, 210,
                41, 337, 79, 109, 139, 347, 143, 283);
        Set<Integer> errorList = Set.of(1425, 28, 4, 41, 743, 347, 287, 57);
