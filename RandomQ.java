...
public class RandomQ {
    ...
    public static void main(String[] args) {
        List<Integer> all = List.of(1143, 97, 72, 115, 5, 312, 516, 300, 53, 152, 547, 305, 128, 78, 90, 46, 47, 77, 127, 490, 1,
                16, 18, 3, 76, 992, 342, 28, 307, 315, 382, 478, 384, 208, 745, 270, 450, 98, 96, 95, 144, 94, 145, 107, 297, 428,
        ...
        Set<Integer> done = Set.of(20, 5, 155, 209, 78, 450, 127, 128, 96, 235, 992, 144, 739, 145, 384, 18, 300, 503, 106, 76, 315,
                124, 273);
